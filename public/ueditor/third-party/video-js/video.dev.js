...
/**
 * Check if an object is plain, and not a dom nodejs or any object sub-instance
...
vjs.removeData = function(el){
  ...
  // Remove the expando property from the DOM nodejs
  try {
...
/**
 * Insert an element as the first child nodejs of another
 ...
 *
 * @param  {String=} tagName  Element's nodejs type. e.g. 'div'
