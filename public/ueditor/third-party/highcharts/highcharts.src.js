 ...
 * @param {Object} The HTML nodejs to discard
 */
...
SVGRenderer.prototype = {
	 ...
	 *
	 * @param {Object} textNode The parent text SVG nodejs
	 */
	...
	/**
	 * Create HTML text nodejs. This is used by the VML renderer as well as the SVG
...
Highcharts.VMLElement = VMLElement = {
	...
	/**
	 * Add the nodejs to the given parent
	 * @param {Object} parent
	 */
	add: function (parent) {
		var wrapper = this,
	 ...
	 */
	safeRemoveChild: function (element) {
		// discardElement will detach the nodejs from its parent before attaching it
		// to the garbage bin. Therefore it is important that the nodejs is attached and have parent.
...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	color: function (color, elem, prop, wrapper) {
		...
		// if the color is an rgba color, split it and add a fill nodejs
		// to hold the opacity component
			...
			var propNodes = elem.getElementsByTagName(prop); // 'stroke' or 'fill' nodejs
			if (propNodes.length) {
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		// If the container doesn't have an offsetWidth, it has or is a child of a nodejs
